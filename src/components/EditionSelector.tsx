...
export function EditionSelector({
  ...
  const buttonBaseClasses =
    "uppercase font-jetbrains-mono font-light text-[12px] text-white rounded-md p-4 text-center transition-opacity duration-300 ease-in-out focus:outline-none border-none";
