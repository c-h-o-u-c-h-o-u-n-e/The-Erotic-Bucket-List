...
export function EditionSelector({
  ...
  const buttonBaseClasses =
    "uppercase font-jetbrains-mono font-light text-[14px] text-black rounded-md p-4 text-center transition-opacity duration-300 ease-in-out focus:outline-none border-none";

  return (
    <Card>
      <CardContent className="p-4 flex flex-row flex-wrap justify-center gap-4">
