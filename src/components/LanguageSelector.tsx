...
export function LanguageSelector({
  ...
  const buttonBaseClasses =
    "uppercase font-inter font-semibold text-white rounded-md px-2 py-2 text-xs text-center transition-opacity duration-300 ease-in-out focus:outline-none border-none";
